...
export default function FornecedorDashboard() {
    ...
    if (status === "loading") {
        return (
            <div className="min-h-screen flex items-center justify-center bg-page-bg dark:bg-slate-900 transition-colors">
            ...
            <main className="container mx-auto px-4 py-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mt-1">
                            Bem-vindo de volta, <span className="font-semibold text-gray-900 dark:text-gray-200">{session?.user?.nome || session?.user?.email}</span>
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm hover:shadow-md transition-all border border-gray-100 dark:border-slate-700 flex items-center justify-between relative overflow-hidden group">
                        ...
                        <div>
                            <p className="text-gray-500 dark:text-gray-400 text-sm font-medium uppercase tracking-wide">Meus Produtos</p>
                    ...
                    <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm hover:shadow-md transition-all border border-gray-100 dark:border-slate-700 flex items-center justify-between relative overflow-hidden group">
                        ...
                        <div>
                            <p className="text-gray-500 dark:text-gray-400 text-sm font-medium uppercase tracking-wide">Vendas Realizadas</p>
                            <p className="text-4xl font-bold text-gray-800 dark:text-white mt-2">
                                {stats.totalVendas}
                            </p>
                        </div>
                    ...
                    <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm hover:shadow-md transition-all border border-gray-100 dark:border-slate-700 flex items-center justify-between relative overflow-hidden group">
                        ...
                        <div>
                            <p className="text-gray-500 dark:text-gray-400 text-sm font-medium uppercase tracking-wide">Faturamento Total</p>
                            <p className="text-4xl font-bold text-gray-800 dark:text-white mt-2 text-green-600 dark:text-green-400">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <Link href="/fornecedor/produtos/novo" className="group bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm hover:shadow-lg transition-all border border-gray-100 dark:border-slate-700 flex flex-col items-center justify-center gap-3 text-center cursor-pointer">
                        ...
                        <span className="font-semibold text-gray-700 dark:text-gray-200 text-lg">Cadastrar Novo Produto</span>
                        <span className="text-xs text-gray-400 dark:text-gray-500">Adicione itens ao seu catálogo</span>
                    </Link>

                    <Link href="/fornecedor/produtos" className="group bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm hover:shadow-lg transition-all border border-gray-100 dark:border-slate-700 flex flex-col items-center justify-center gap-3 text-center cursor-pointer">
                        ...
                        <span className="font-semibold text-gray-700 dark:text-gray-200 text-lg">Gerenciar Catálogo</span>
                        <span className="text-xs text-gray-400 dark:text-gray-500">Edite ou remova seus produtos</span>
                    </Link>

                    <Link href="/fornecedor/pedidos" className="group bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm hover:shadow-lg transition-all border border-gray-100 dark:border-slate-700 flex flex-col items-center justify-center gap-3 text-center cursor-pointer">
                        ...
                        <span className="font-semibold text-gray-700 dark:text-gray-200 text-lg">Ver Pedidos</span>
                        <span className="text-xs text-gray-400 dark:text-gray-500">Acompanhe suas vendas</span>
                    </Link>
                </div>
            </main>
        </div>
